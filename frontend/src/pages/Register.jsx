...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        toast.success('Registration successful! Welcome to NexaChain.');
      ...
      <div className="w-full max-w-md p-8 relative z-10">
        <div className="bg-surface-dark/80 backdrop-blur-xl border border-[#29382d] rounded-2xl p-8 shadow-2xl animate-glow">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-black text-white tracking-tight">Join InvestmentCo</h1>
            <p className="text-text-secondary mt-2">Register and start earning today</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            <div className="space-y-1">
              ...
              <div className="relative">
                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-text-secondary material-symbols-outlined text-[20px]">person</span>
                <input
                  type="text"
                  required
            ...
            <div className="space-y-1">
              <label className="text-xs font-bold text-text-secondary uppercase tracking-wider">Referral Code (Optional)</label>
              <div className="relative">
                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-text-secondary material-symbols-outlined text-[20px]">group</span>
                <input
                  type="text"
                  className="w-full bg-[#111813] border border-[#29382d] text-white rounded-xl py-3 pl-10 pr-4 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all placeholder:text-gray-600"
